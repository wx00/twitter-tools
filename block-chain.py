...
if __name__ == "__main__":
    ...
    user_source.add_argument(
        '--screenname', help='Username(w/o @) to start block chain.'
    )
    user_source.add_argument(
        '--from-file',
        metavar='FILE',
    ...
    parser.add_argument('--levels', metavar='N', type=int, help='Levels to block. ')
    parser.add_argument(
        '--exclude-followers',
        metavar='TRUE|FALSE',
        type=str2bool,
    ...
    friends_set = set(follower_ids) + set(friend_ids)
